...
namespace DVLD.Applications.InternationalLicenses
{
    public partial class frmNewInternationalLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            _LocalLicenseID = SelectedLicenseID;
            _License = clsLicenses.Find(_LocalLicenseID);
            ctrlApplicationInfo1.LoadApplicationInfo(_License.ApplicationID);
        ...
        private void btnIssueLicense_Click(object sender, EventArgs e)
        {
            ...
            InternationalLicense.PaidFees = clsApplicationTypes.Find((int)clsApplications.enApplicationType.NewInternationalLicense).ApplicationTypeFees;
